...
def main():
    ...
    def game1():
        ...
        if lives >= 1:
            ...
            gradaA1 = canvasGame.create_image(475, 515, image=nuevoGradA1, anchor=tk.NW)
            gradaA2 = canvasGame.create_image(475, 565, image=nuevoGradA1, anchor=tk.NW)
            gradaA3 = canvasGame.create_image(475, 615, image=nuevoGradA1, anchor=tk.NW)
            gradaB1 = canvasGame.create_image(1000, 315, image=nuevoGradA1, anchor=tk.NW)
            gradaB2 = canvasGame.create_image(1000, 369, image=nuevoGradA1, anchor=tk.NW)
            gradaB3 = canvasGame.create_image(1000, 419, image=nuevoGradA1, anchor=tk.NW)
